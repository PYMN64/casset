...
| `interactions` | لایک، فالو، علاقه‌مندی، کامنت، بلاک کامنت‌گذار، **بازنشر (Repost)** | ✅ کامل — مدل + endpoint هر هفت نوع تعامل با `services.py`، همه به Notification وصل. |
